...
import { FaGithub, FaLinkedin, FaTwitter, FaBehanceSquare } from "react-icons/fa";
    ...
    <footer className=" relative bg-white dark:bg-black mt-32 border-t border-zinc-200 dark:border-zinc-800 z-40">
      <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="flex justify-center space-x-6">
          <a href="https://www.linkedin.com/in/loupraxedes/" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-blue-500 transition-colors">
            <span className="sr-only">LinkedIn</span>
            <FaLinkedin className="h-6 w-6" />
          </a>
          <a href="https://www.behance.net/loupraxedes" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-blue-500 transition-colors">
